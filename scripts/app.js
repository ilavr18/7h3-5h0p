...
const tshirtElement = [...document.getElementsByClassName("tshirt-image")]
...
whiteBtn.onclick = function () {
    tshirtElement.forEach(element => element.src = "img/tshirts/tshirt_white.jpg")
    whiteBtn.style.border = "3px solid #cc0000"
    yellowBtn.style.border = "1px solid #000000"
    greenBtn.style.border = "1px solid #000000"
}
yellowBtn.onclick = function () {
    tshirtElement.forEach(element => element.src = "img/tshirts/tshirt_yellow.jpg")
    whiteBtn.style.border = "1px solid #000000"
    yellowBtn.style.border = "3px solid #cc0000"
    greenBtn.style.border = "1px solid #000000"
}
greenBtn.onclick = function () {
    tshirtElement.forEach(element => element.src = "img/tshirts/tshirt_green.jpg")
    whiteBtn.style.border = "1px solid #000000"
    yellowBtn.style.border = "1px solid #000000"
